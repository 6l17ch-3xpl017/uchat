 ...
 * ftheader.h
 *
 *   Build macros of the FreeType 2 lib.
 *
...
#define FT_CONFIG_CONFIG_H  <freetype/config/ftconfig.h>
   ...
   * @description:
   *   A macro used in `#include` statements to name the file containing
   *   FreeType~2 interface to the standard C lib functions.
   *
   */
...
#define FT_CONFIG_OPTIONS_H  <freetype/config/ftoption.h>
   ...
   *   list of FreeType~2 modules that are statically linked to new lib
