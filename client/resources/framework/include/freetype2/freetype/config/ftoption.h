...
FT_BEGIN_HEADER
   ...
   * standard build of the FreeType lib.  There are three ways to use
   * this file to build project-specific versions of the lib:
   *
   * - You can modify this file by hand, but this is not recommended in
   *   cases where you would like to build several versions of the lib
   ...
   *   that are statically linked to the lib at compile time.  By
...
#define FT_CONFIG_OPTION_ENVIRONMENT_PROPERTIES
   ...
   * technology similar to ClearType in this build of the lib.  This
   * technology triples the resolution in the direction color subpixels.  To
   * mitigate color fringes inherent to this technology, you also need to
   * explicitly set up LCD filtering.
   *
   * Note that this feature is covered by several Microsoft patents and
   * should not be activated in any default build of the lib.  When this
...
/* #define FT_CONFIG_OPTION_SUBPIXEL_RENDERING */
   ...
   * problems when compiling the lib in strict ANSI mode.
   *
...
#define FT_CONFIG_OPTION_USE_ZLIB
   ...
   *   installation of the ZLib lib.  This is useful on systems like
...
/* #define FT_CONFIG_OPTION_DISABLE_STREAM_SUPPORT */
   ...
   *   This requires help from the external libpng lib.  Uncompressed
...
#define FT_CONFIG_OPTION_USE_PNG
   ...
   * HarfBuzz support.
   *
   *   FreeType uses the HarfBuzz lib to improve auto-hinting of OpenType
...
/* #undef FT_CONFIG_OPTION_USE_HARFBUZZ */
   ...
   * Brotli support.
   *
   *   FreeType uses the Brotli lib to provide support for decompressing
   *   WOFF2 streams.
   *
   *   Define this macro if you want to enable this 'feature'.
   *
...
#define FT_RENDER_POOL_SIZE  16384L
   ...
   *   FreeType lib object.  32~is the default.
   */
#define FT_MAX_MODULES  32
   ...
   *
   *   Define `FT_DEBUG_LEVEL_ERROR` to build the lib in debug mode.
...
/* #define FT_DEBUG_AUTOFIT */
   ...
   *   compile it within your build of the lib, you should define
...
#define TT_CONFIG_OPTION_BDF
   ...
   * lib fuzzer spend less time to handle broken fonts).
   *
