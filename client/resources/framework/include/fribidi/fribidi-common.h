/* FriBidi
 * fribidi-common.h - common include for lib headers
 *
 * Author:
 ...
 * along with this lib, in a file named COPYING; if not, write to the
...
/* FRIBIDI_ENTRY is a macro used to declare lib entry points. */
