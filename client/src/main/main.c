//#include "client.h"
//
//static t_client_data user_data;
//
//static long long read_socket(int socket)
//{
//    char buf[20000];
...
//
//    return send_json(json, user_data.server_attr.socket);
//}
//
...
//
//    user_data.server_attr.socket = sockfd;
//}
//
///** login_window **/
...
////
////    strcpy(user_data.user_attr.username, gtk_entry_get_text(username_entry));
////    strcpy(user_data.user_attr.password , gtk_entry_get_text(password_entry));
//
//    cmc_log_info("username_entry = %s | password_entry = %s",
//                 user_data.user_attr.username,
//                 user_data.user_attr.password);
//
//    if ((errno = create_user_data()) == 104 || errno == 103 || errno == 0)
//    {
...
//    strcpy(user_data.user_attr.password, gtk_entry_get_text(entry));
//}
//
//void on_username_entry_changed(GtkEntry *entry)
//{
//    cmc_log_info("USERNAME ENTRY CHANGED");
//    strcpy(user_data.user_attr.username, gtk_entry_get_text(entry));
//}
///***********************************************/
//
///** register_page **/
...
//        GtkWidget *toplevel = gtk_widget_get_toplevel(button);
//        cmc_log_info("User reg complete");
//    }
//    else
//    {
//        //ToDo: Raise error in window
...
//    strcpy(user_data.user_attr.email, gtk_entry_get_text(entry));
//
//    cmc_log_info("[Current email = %s]", user_data.user_attr.email);
//}
//
//void on_phonenumber_entry_changed(GtkEntry *entry)
//{
//    cmc_log_info("PHONE_NUMBER ENTRY CHANGED");
//    strcpy(user_data.user_attr.ph_number, gtk_entry_get_text(entry));
//}
//
//void on_age_entry_changed(GtkEntry *entry)
//{
//    cmc_log_info("AGE ENTRY CHANGED");
//    strcpy(user_data.user_attr.age, gtk_entry_get_text(entry));
//    cmc_log_info("[Current age = %s]", user_data.user_attr.age);
//}
//
...
//    strcpy(user_data.user_attr.fullname, gtk_entry_get_text(entry));
//    cmc_log_info("[Current fullname = %s]", user_data.user_attr.fullname);
//}
//
...
//    json_object_set_new(msg, "message_owner_id", json_string(user_data.user_attr.username));
...
//
//    send_json(json, user_data.server_attr.socket);
//}
//
...
//    GtkWidget *msg = msg_widget_factory(P_MSG, text, user_data.user_attr.username);
//
