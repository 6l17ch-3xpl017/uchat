/* cairo - a vector graphics lib with display and print output
 *
 ...
 * the MPL or the LGPL.
 *
 * You should have received a copy of the LGPL along with this lib
 * in the file COPYING-LGPL-2.1; if not, write to the Free Software
 * Foundation, Inc., 51 Franklin Street, Suite 500, Boston, MA 02110-1335, USA
 * You should have received a copy of the MPL along with this lib
 ...
 *
 * The Original Code is the cairo graphics lib.
 *
 ...
 * usage where a lib or application wants to cache a reference
