 ...
 * GDK_PIXBUF_MAJOR:
 * 
 * Major version of gdk-pixbuf lib, that is the "0" in
 * "0.8.2" for example.
 */
/**
 * GDK_PIXBUF_MINOR:
 * 
 * Minor version of gdk-pixbuf lib, that is the "8" in
 * "0.8.2" for example.
 */
/**
 * GDK_PIXBUF_MICRO:
 * 
 * Micro version of gdk-pixbuf lib, that is the "2" in
 * "0.8.2" for example.
 */
/**
 * GDK_PIXBUF_VERSION:
 ...
 * 
 * The major version number of the gdk-pixbuf lib.  (e.g. in
 * gdk-pixbuf version 1.2.5 this is 1.) 
 * 
 * 
 * This variable is in the lib, so represents the
 * gdk-pixbuf lib you have linked against. Contrast with the
 ...
 * 
 * The minor version number of the gdk-pixbuf lib.  (e.g. in
 ...
 * 
 * The micro version number of the gdk-pixbuf lib.  (e.g. in
 ...
 * gdk_pixbuf_version:
 * 
 * Contains the full version of the gdk-pixbuf lib as a string.
