/* GdkPixbuf lib - GdkPixbuf data structure
 *
 ...
 * channel.  It is not included in the gdk-pixbuf lib for
 ...
 * the gdk-pixbuf lib.  Currently only RGB is supported.
 */
 ...
 * GdkPixbuf:
 * 
 * This is the main structure in the gdk-pixbuf lib.  It is
