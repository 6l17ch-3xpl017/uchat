/* gstdio.h - GFilename wrappers for C lib functions
 *
...
/* Wrappers for C lib functions that take pathname arguments. On
 ...
 * encoding, and not the encoding accepted by the C lib or Win32
 * API.
 */
